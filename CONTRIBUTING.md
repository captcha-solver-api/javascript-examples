...
1. **Fork the repository**  
   ...
   ```bash
   git clone https://github.com/captcha-solver-api/javascript-examples
   ```
...
By contributing to this project, you agree to abide by our [Code of Conduct](https://github.com/captcha-solver-api/javascript-examples/blob/main/CODE_OF_CONDUCT.md). Please be respectful and considerate to other contributors.
